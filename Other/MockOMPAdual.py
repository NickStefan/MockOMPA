...
SixUnderGirls_Free = ofunc.ScoreEvent(SixUnderGirlsEvents[0], ov.SixUnderGirls_Points, ov.SixUnderGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderGirls_Breast = ofunc.ScoreEvent(SixUnderGirlsEvents[1], ov.SixUnderGirls_Points, ov.SixUnderGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderGirls_Back = ofunc.ScoreEvent(SixUnderGirlsEvents[2], ov.SixUnderGirls_Points, ov.SixUnderGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderGirls_Fly = ofunc.ScoreEvent(SixUnderGirlsEvents[3], ov.SixUnderGirls_Points, ov.SixUnderGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)

SixUnderBoys_Free = ofunc.ScoreEvent(SixUnderBoysEvents[0], ov.SixUnderBoys_Points, ov.SixUnderBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderBoys_Breast = ofunc.ScoreEvent(SixUnderBoysEvents[1], ov.SixUnderBoys_Points, ov.SixUnderBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderBoys_Back = ofunc.ScoreEvent(SixUnderBoysEvents[2], ov.SixUnderBoys_Points, ov.SixUnderBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
SixUnderBoys_Fly = ofunc.ScoreEvent(SixUnderBoysEvents[3], ov.SixUnderBoys_Points, ov.SixUnderBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)

SevenEightGirls_Free = ofunc.ScoreEvent(SevenEightGirlsEvents[0], ov.SevenEightGirls_Points, ov.SevenEightGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightGirls_Breast = ofunc.ScoreEvent(SevenEightGirlsEvents[1], ov.SevenEightGirls_Points, ov.SevenEightGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightGirls_Back = ofunc.ScoreEvent(SevenEightGirlsEvents[2], ov.SevenEightGirls_Points, ov.SevenEightGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightGirls_Fly = ofunc.ScoreEvent(SevenEightGirlsEvents[3], ov.SevenEightGirls_Points, ov.SevenEightGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightGirls_IM = ofunc.ScoreEvent(SevenEightGirlsEvents[4], ov.SevenEightGirls_Points, ov.SevenEightGirls_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

SevenEightBoys_Free = ofunc.ScoreEvent(SevenEightBoysEvents[0], ov.SevenEightBoys_Points, ov.SevenEightBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightBoys_Breast = ofunc.ScoreEvent(SevenEightBoysEvents[1], ov.SevenEightBoys_Points, ov.SevenEightBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightBoys_Back = ofunc.ScoreEvent(SevenEightBoysEvents[2], ov.SevenEightBoys_Points, ov.SevenEightBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightBoys_Fly = ofunc.ScoreEvent(SevenEightBoysEvents[3], ov.SevenEightBoys_Points, ov.SevenEightBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
SevenEightBoys_IM = ofunc.ScoreEvent(SevenEightBoysEvents[4], ov.SevenEightBoys_Points, ov.SevenEightBoys_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

NineTenGirls_Free = ofunc.ScoreEvent(NineTenGirlsEvents[0], ov.NineTenGirls_Points, ov.NineTenGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenGirls_Breast = ofunc.ScoreEvent(NineTenGirlsEvents[1], ov.NineTenGirls_Points, ov.NineTenGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenGirls_Back = ofunc.ScoreEvent(NineTenGirlsEvents[2], ov.NineTenGirls_Points, ov.NineTenGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenGirls_Fly = ofunc.ScoreEvent(NineTenGirlsEvents[3], ov.NineTenGirls_Points, ov.NineTenGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenGirls_IM = ofunc.ScoreEvent(NineTenGirlsEvents[4], ov.NineTenGirls_Points, ov.NineTenGirls_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

NineTenBoys_Free = ofunc.ScoreEvent(NineTenBoysEvents[0], ov.NineTenBoys_Points, ov.NineTenBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenBoys_Breast = ofunc.ScoreEvent(NineTenBoysEvents[1], ov.NineTenBoys_Points, ov.NineTenBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenBoys_Back = ofunc.ScoreEvent(NineTenBoysEvents[2], ov.NineTenBoys_Points, ov.NineTenBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenBoys_Fly = ofunc.ScoreEvent(NineTenBoysEvents[3], ov.NineTenBoys_Points, ov.NineTenBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
NineTenBoys_IM = ofunc.ScoreEvent(NineTenBoysEvents[4], ov.NineTenBoys_Points, ov.NineTenBoys_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

ElevenTwelveGirls_Free = ofunc.ScoreEvent(ElevenTwelveGirlsEvents[0], ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveGirls_Breast = ofunc.ScoreEvent(ElevenTwelveGirlsEvents[1], ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveGirls_Back = ofunc.ScoreEvent(ElevenTwelveGirlsEvents[2], ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveGirls_Fly = ofunc.ScoreEvent(ElevenTwelveGirlsEvents[3], ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveGirls_IM = ofunc.ScoreEvent(ElevenTwelveGirlsEvents[4], ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

ElevenTwelveBoys_Free = ofunc.ScoreEvent(ElevenTwelveBoysEvents[0], ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveBoys_Breast = ofunc.ScoreEvent(ElevenTwelveBoysEvents[1], ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveBoys_Back = ofunc.ScoreEvent(ElevenTwelveBoysEvents[2], ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveBoys_Fly = ofunc.ScoreEvent(ElevenTwelveBoysEvents[3], ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
ElevenTwelveBoys_IM = ofunc.ScoreEvent(ElevenTwelveBoysEvents[4], ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

ThirteenFourteenGirls_Free = ofunc.ScoreEvent(ThirteenFourteenGirlsEvents[0], ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenGirls_Breast = ofunc.ScoreEvent(ThirteenFourteenGirlsEvents[1], ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenGirls_Back = ofunc.ScoreEvent(ThirteenFourteenGirlsEvents[2], ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenGirls_Fly = ofunc.ScoreEvent(ThirteenFourteenGirlsEvents[3], ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenGirls_IM = ofunc.ScoreEvent(ThirteenFourteenGirlsEvents[4], ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

ThirteenFourteenBoys_Free = ofunc.ScoreEvent(ThirteenFourteenBoysEvents[0], ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenBoys_Breast = ofunc.ScoreEvent(ThirteenFourteenBoysEvents[1], ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenBoys_Back = ofunc.ScoreEvent(ThirteenFourteenBoysEvents[2], ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenBoys_Fly = ofunc.ScoreEvent(ThirteenFourteenBoysEvents[3], ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
ThirteenFourteenBoys_IM = ofunc.ScoreEvent(ThirteenFourteenBoysEvents[4], ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

FifteenEighteenGirls_Free = ofunc.ScoreEvent(FifteenEighteenGirlsEvents[0], ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenGirls_Breast = ofunc.ScoreEvent(FifteenEighteenGirlsEvents[1], ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenGirls_Back = ofunc.ScoreEvent(FifteenEighteenGirlsEvents[2], ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenGirls_Fly = ofunc.ScoreEvent(FifteenEighteenGirlsEvents[3], ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenGirls_IM = ofunc.ScoreEvent(FifteenEighteenGirlsEvents[4], ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

FifteenEighteenBoys_Free = ofunc.ScoreEvent(FifteenEighteenBoysEvents[0], ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_Free_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenBoys_Breast = ofunc.ScoreEvent(FifteenEighteenBoysEvents[1], ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_Breast_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenBoys_Back = ofunc.ScoreEvent(FifteenEighteenBoysEvents[2], ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_Back_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenBoys_Fly = ofunc.ScoreEvent(FifteenEighteenBoysEvents[3], ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_Fly_Points, ov.ScoringScheme3, ov.SwimTeamList)
FifteenEighteenBoys_IM = ofunc.ScoreEvent(FifteenEighteenBoysEvents[4], ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_IM_Points, ov.ScoringScheme3, ov.SwimTeamList)

SixUnderGirls_FreeRelay = ofunc.ScoreEvent(SixUnderGirlsFreeRelay, ov.SixUnderGirls_Points, ov.SixUnderGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
SixUnderBoys_FreeRelay = ofunc.ScoreEvent(SixUnderBoysFreeRelay, ov.SixUnderBoys_Points, ov.SixUnderBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
SevenEightGirls_FreeRelay = ofunc.ScoreEvent(SevenEightGirlsFreeRelay, ov.SevenEightGirls_Points, ov.SevenEightGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
SevenEightBoys_FreeRelay = ofunc.ScoreEvent(SevenEightBoysFreeRelay, ov.SevenEightBoys_Points, ov.SevenEightBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
NineTenGirls_FreeRelay = ofunc.ScoreEvent(NineTenGirlsFreeRelay, ov.NineTenGirls_Points, ov.NineTenGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
NineTenBoys_FreeRelay = ofunc.ScoreEvent(NineTenBoysFreeRelay, ov.NineTenBoys_Points, ov.NineTenBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
ElevenTwelveGirls_FreeRelay = ofunc.ScoreEvent(ElevenTwelveGirlsFreeRelay, ov.ElevenTwelveGirls_Points, ov.ElevenTwelveGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
ElevenTwelveBoys_FreeRelay = ofunc.ScoreEvent(ElevenTwelveBoysFreeRelay, ov.ElevenTwelveBoys_Points, ov.ElevenTwelveBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
ThirteenFourteenGirls_FreeRelay = ofunc.ScoreEvent(ThirteenFourteenGirlsFreeRelay, ov.ThirteenFourteenGirls_Points, ov.ThirteenFourteenGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
ThirteenFourteenBoys_FreeRelay = ofunc.ScoreEvent(ThirteenFourteenBoysFreeRelay, ov.ThirteenFourteenBoys_Points, ov.ThirteenFourteenBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
FifteenEighteenGirls_FreeRelay = ofunc.ScoreEvent(FifteenEighteenGirlsFreeRelay, ov.FifteenEighteenGirls_Points, ov.FifteenEighteenGirls_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
FifteenEighteenBoys_FreeRelay = ofunc.ScoreEvent(FifteenEighteenBoysFreeRelay, ov.FifteenEighteenBoys_Points, ov.FifteenEighteenBoys_FreeRelay_Points, ov.ScoringScheme4, ov.SwimTeamList)
